        ...
        <div>
            <div className='fixed left-0 right-0 bottom-0 w-[50%] mx-auto 
              ...
              bg-white/10 dark:bg-gray-900/10 
               ...
               shadow-lg font-bold text-[18px] py-[12px] lg:py-[25px] 
               text-gray-950 dark:text-white 
               transition-all duration-500 
               flex items-center justify-between 
               lg:px-[30px] px-[15px]'>
                <div className='border-r-[2px] border-gray-400 flex items-center gap-[5px] lg:gap-[20px] transition-all duration-500 pr-[5px] lg:pr-[43px] dark:border-gray-300 lg:border-none'>
                    <select className='bg-gray-300 transition-all appearance-none duration-500 text-gray-950 dark:text-gray-200 cursor-pointer dark:bg-gray-900 px-[5px] rounded-[5px]' value={i18n.language} onChange={(e) => i18n.changeLanguage(e.target.value)} name="" id="">
                ...
                <div className='flex items-center pl-[5px] w-[50%] justify-between'>
